...
def deHex2(str1):  #Converts a string of Hex to an array of Base64 bytes
    inputBin = binascii.unhexlify(str1)
    myResult2 = []
...
#__________________CHALLENGE___________________
...
myAnswer3=binascii.a2b_base64(myAnswer2)   #string to B64
myAnswer3=binascii.hexlify(myAnswer3)      #B64 to Hex
#myAnswer3=binascii.b2a_base64(myAnswer3)   #NOT CORRECT!
myAnswer3=binascii.b2a_base64(myAnswer3)
myAnswer4=binascii.hexlify(myAnswer3).decode('ASCII')
myAnswer4=myAnswer3
